...
def main():
    parser = argparse.ArgumentParser(description="Convert a CSV file to an XLSX (Excel) file.")
    parser.add_argument('input_file', type=Path, help='Path to the input .csv file')
    parser.add_argument('-o', '--output_file', type=Path, default=None, help='Path for the output .xlsx file')

...
def excel_to_csv(input_file: Path, separator: str = ',', output_file: Path = None) -> None:
...
def main():
    parser = argparse.ArgumentParser(description="Convert an XLSX (Excel) file to a CSV file.")
    ...
    parser.add_argument(
        '-s', '--separator', type=parse_separator_argument, default=',',

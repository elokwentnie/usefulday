...
def main():
    parser = argparse.ArgumentParser(description="Convert a .jpg or .jpeg image to .png format.")
    parser.add_argument('input_file', type=Path, help='Input .jpg or .jpeg file path')
    parser.add_argument('-o', '--output_file', type=Path, default=None, help='Output .png file path')

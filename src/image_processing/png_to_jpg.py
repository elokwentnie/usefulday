...
def png_to_jpg(input_file, output_file=None, quality=85):
...
def main():
    ...
    parser.add_argument('input_file', metavar='input_file', type=str, default=None, help='Input .png file path')
    ...
    if os.path.isfile(args.input_file) and args.input_file.lower().endswith('.png'):
        png_to_jpg(args.input_file, args.output_file)
    else:
        print(f"Error: {args.input_file} does not exist or the extension is not .png")
        sys.exit(1)

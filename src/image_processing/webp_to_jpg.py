...
def webp_to_jpg(input_file: Path, output_file: Path = None, background_color: str = 'black') -> None:
...
def main():
    ...
    parser.add_argument('-o', '--output_file', type=Path, default=None, help='Output .jpg file name')
    parser.add_argument('-b', '--background', choices=['white', 'black'], default='black',
